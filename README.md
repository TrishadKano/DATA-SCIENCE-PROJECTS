...
**I have utilised a variety of tools and platforms to analyse and present data effectively:**

- Python (Pandas, NumPy, Scikit-learn, Matplotlib, Seaborn)

- SQL (MySQL, PostgreSQL, Microsoft SQL Server, SSMS)

- Microsoft Power BI for dashboarding and visualisation
...
- Creating interactive dashboards and visualisations in Power BI 📊
...
**🚀 I am passionate about turning raw data into meaningful insights that support strategic decision-making. Whether it's uncovering patterns, forecasting trends, or building end-to-end analytical pipelines, this repository reflects my commitment to data excellence.**


**🤝 I am always open to collaborations, learning opportunities, and contributing to impactful projects**
